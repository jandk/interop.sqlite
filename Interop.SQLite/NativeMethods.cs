...
namespace Interop.SQLite
{
    internal static class NativeMethods
    {
        ...
        public static extern SQLite3Error Prepare(IntPtr db, byte[] utf8Sql, int sqlLength, out IntPtr statement,
                                                  out IntPtr unusedSql);

        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "sqlite3_prepare_v2")]
        public static extern SQLite3Error PrepareV2(IntPtr db, byte[] utf8Sql, int sqlLength, out IntPtr statement,
                                                    out IntPtr unusedSql);
